...
public class UserGroupBulkUploadModifyMSSQL extends BaseTest
{
	...
	public void modifyUserGroupInMSSQL() throws InterruptedException, IOException
	{
		...
		String bulkUploadModify = UserGroupMSSQLPage.modifySuperGroupExcelBulckUploadMSSQL();
